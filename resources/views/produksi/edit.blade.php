                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                            placeholder="Tanggal" name="tanggal" value="{{ $produksi->tanggal ?? old('tanggal') }}" readonly >
                        @error('tanggal')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control mb-10 @error('kode') is-invalid @enderror" id="kode" name="kode" style="width: 100%">
                            ...
                            @foreach ($datakode as $value => $label)
                                <option value="{{ $value }}" @if ($value == $produksi->kode || old('kode') == $value) selected @endif>{{ $label }}</option>
                            @endforeach
                        </select>
                        @error('kode')
                        <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity"
                            placeholder="Actual Quantity" name="quantity" value="{{ $produksi->quantity ?? old('quantity') }}">
                        @error('quantity')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('reject') is-invalid @enderror" id="reject"
                            Reject="reject" placeholder="Not Good" name="reject" value="{{ $produksi->reject ?? old('reject') }}">
                        @error('reject')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                            ...
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('a_start_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->a_start_time ?? old('a_start_time') }}">
                                </div>
                            </div>
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('a_end_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->a_end_time ?? old('a_end_time') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control @error('a_time') is-invalid @enderror" id="a_time"
                                placeholder="A Time" name="a_time" value="{{ $produksi->a_time ?? old('a_time') }}" readonly>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 border">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control @error('b_start_time') is-invalid @enderror"
                                    ...
                                    value="{{ $produksi->b_start_time ?? old('b_start_time') }}" />
                            </div>
                        </div>
                        <div class="col-md-6 border">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control @error('b_end_time') is-invalid @enderror"
                                    ...
                                    value="{{ $produksi->b_end_time ?? old('b_end_time') }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control @error('b_time') is-invalid @enderror" id="b_time"
                            placeholder="B Time" name="b_time" value="{{ $produksi->b_time ?? old('b_time') }}" readonly>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('c_start_time') is-invalid @enderror"
                                        id="c_start_time" placeholder="" name="c_start_time"
                                        value="{{ $produksi->c_start_time ?? old('c_start_time') }}" />
                                </div>
                            </div>
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('c_end_time') is-invalid @enderror"
                                        id="c_end_time" placeholder="" name="c_end_time"
                                        value="{{ $produksi->c_end_time ?? old('c_end_time') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="c_time">Total Waktu Kategori C</label>
                            <input type="time" class="form-control @error('c_time') is-invalid @enderror" id="c_time"
                                placeholder="C Time" name="c_time" value="{{ $produksi->c_time ?? old('c_time') }}" readonly>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('d_start_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->d_start_time ?? old('d_start_time') }}" />
                                </div>
                            </div>
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('d_end_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->d_end_time ?? old('d_end_time') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control @error('d_time') is-invalid @enderror" id="d_time"
                                placeholder="D Time" name="d_time" value="{{ $produksi->d_time ?? old('d_time') }}" readonly>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('e_start_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->e_start_time ?? old('e_start_time') }}" />
                                </div>
                            </div>
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('e_end_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->e_end_time ?? old('e_end_time') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control @error('e_time') is-invalid @enderror" id="e_time"
                                placeholder="E Time" name="e_time" value="{{ $produksi->e_time ?? old('e_time') }}" readonly>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('f_start_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->f_start_time ?? old('f_start_time') }}" />
                                </div>
                            </div>
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('f_end_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->f_end_time ?? old('f_end_time') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control @error('f_time') is-invalid @enderror" id="f_time"
                                placeholder="F Time" name="f_time" value="{{ $produksi->f_time ?? old('f_time') }}" readonly>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('g_start_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->g_start_time ?? old('g_start_time') }}" />
                                </div>
                            </div>
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('g_end_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->g_end_time ?? old('g_end_time') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control @error('g_time') is-invalid @enderror" id="g_time"
                                placeholder="G Time" name="g_time" value="{{ $produksi->g_time ?? old('g_time') }}" readonly>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('h_start_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->h_start_time ?? old('h_start_time') }}" />
                                </div>
                            </div>
                            <div class="col-md-6 border">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('h_end_time') is-invalid @enderror"
                                        ...
                                        value="{{ $produksi->h_end_time ?? old('h_end_time') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control @error('h_time') is-invalid @enderror" id="h_time"
                                placeholder="H Time" name="h_time" value="{{ $produksi->h_time ?? old('h_time') }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control @error('down_time') is-invalid @enderror" id="down_time"
                            placeholder="Down Time" name="down_time" value="{{ $produksi->down_time ?? old('down_time') }}" readonly>
                    </div>
